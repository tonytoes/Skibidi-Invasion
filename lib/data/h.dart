class h {
  static const List<Map<String, dynamic>> scenarioData = [
    ...
    {
      'dialogue': "Mem leads you to a room filled with books and study notes.", // index 19
    ...
    {
      'dialogue': "In order to stop this brainrot madness", // index 000
      'backgroundImage':  'assets/images/bg/hq-training-room.png',
      'characterName': 'Mem',
      'characterSprite': 'assets/images/characters/pose2/242.png',
    },
    {
      'dialogue': "we must defeat the source of this infection- THE SKIBIDI KING!", // index 000
      'backgroundImage':  'assets/images/bg/hq-training-room.png',
      'characterName': 'Mem',
      'characterSprite': 'assets/images/characters/pose2/242.png',
    },
    {
      'dialogue': "defeating the skibidi king will turn everyone back to normal.", // index 000
      'backgroundImage':  'assets/images/bg/hq-training-room.png',
      'characterName': 'Mem',
      'characterSprite': 'assets/images/characters/pose2/242.png',
    },
    ...
    {
      'dialogue': "Alright, Lets go outside and find the source of all this madness!", // index 36
      'backgroundImage': 'assets/images/bg/hq-training-room.png',
      'characterName': 'Mem',
      'characterSprite': 'assets/images/characters/pose1/111.png',
    },
